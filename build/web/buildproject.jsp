...
<main>
    <div class="container">
        ...
        <form action="/submit-post" method="post">
            ...
            <div class="mb-3">
                <label for="post-description" class="form-label">Description (Optional)</label>
                <textarea class="form-control" id="post-description" name="description" rows="3"></textarea>
            </div>
            <div class="mb-3">
                <label for="post-goal" class="form-label">Goal</label>
                <input type="number" class="form-control" id="post-goal" name="goal" placeholder="0.00" min="0" step="0.01" required>
            </div>
            <div class="mb-3">
