...
<html>
    ...
    <body onload="time()">
        ...
        <div class="charityorg-management container-fluid bg-secondary-subtle show active" style="height: 36rem;">
            <div class="row">
                ...
                <div class="charityorg-management container col-10 py-3 bg-secondary-subtle">
